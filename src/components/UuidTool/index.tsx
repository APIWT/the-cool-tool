        ...
        <>
            <Container>
                <Text>
                    ...
                    <Label>
                        Exclude Dashes:
                        <input type="checkbox" onClick={e => setExcludeDashes(e.target !== null ? (e.target as HTMLInputElement).checked : false)} />
                    </Label>
                    <Label>
                        Caps Lock:
                        <input type="checkbox" onClick={e => setCapsLock(e.target !== null ? (e.target as HTMLInputElement).checked : false)} />
                    </Label>
                    <Label>
